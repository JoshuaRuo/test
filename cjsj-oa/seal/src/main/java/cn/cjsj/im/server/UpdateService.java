...
public class UpdateService extends Service {
    ...
    public void onCreate() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            startForeground(1, new Notification()); //这个id不要和应用内的其他同志id一样，不行就写 int.maxValue()
        }
    }
    ...
    private void buildNotification() {
        ...
        int smallIcon = getResources().getIdentifier("oa_notification_icon", "drawable", getPackageName());
