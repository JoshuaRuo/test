...
public class AddedValueTaxInvoiceActivity extends BaseActivity implements View.OnClickListener {


    @Bind(R.id.added_value_webview)
    WebView mWebView;
    @Bind(R.id.added_value_progressbar)
    ...
    private static final String TAG = "AddedValueTaxInvoiceActivity";

    private static final String BASE_URL = ConstantValue.WEB_BASE_URL + "html/vat_invoice/invoice_list.html";
    private static final String BASE_apply_URL = ConstantValue.WEB_BASE_URL + "html/vat_invoice/apply_invoice.html";
        ...
        mWebView.setWebViewClient(new WebViewClient(){
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                if (url.contains("protocol://android.finish")) {
                    ...
                    return true;
                } else if (url.contains("invoice_detail.html")) {
                    mHeadRightText.setVisibility(View.VISIBLE);
            ...
            case R.id.btn_left:
                if (isContact) {
                    ...
                    if (mHisIndex != 0) {//当webview不是处于第一页面时，返回上一个页面
                        ...
                        if (mWebView.getUrl().contains("invoice_list.html")) {
                            mHeadRightText.setVisibility(View.VISIBLE);
                            mHeadRightText.setText("新增");
                            mIsApplyHistory = false;
                            mIsApplyApproval = false;
                        ...
                        } else if (mWebView.getUrl().contains("invoice_detail.html")) {
                            mIsApplyApproval = true;
                            mIsApplyHistory = false;
                            mHeadRightText.setText("审批进度");
                            mHeadRightText.setVisibility(View.VISIBLE);
