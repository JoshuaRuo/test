...
import cn.cjsj.im.server.network.http.SyncHttpClient;
import cn.cjsj.im.server.utils.json.JsonMananger;

/**
 * Created by LuoYang on 17/12/15.
 * Company RongCloud
 */
public class BaseAction {

//    private static final String DOMAIN = "http://api.sealtalk.im";
    private static final String DOMAIN = "http://120.27.250.6:8080";  //外网环境
//    private static final String DOMAIN = "http://192.168.15.203:8555";  //本地环境
