...
import cn.cjsj.im.server.request.AddGroupMemberRequest;
import cn.cjsj.im.server.request.AddToBlackListRequest;
import cn.cjsj.im.server.request.AgreeFriendsRequest;
import cn.cjsj.im.server.request.ChangePasswordRequest;
import cn.cjsj.im.server.request.CheckPhoneRequest;
import cn.cjsj.im.server.request.CreateGroupRequest;
import cn.cjsj.im.server.request.DeleteFriendRequest;
import cn.cjsj.im.server.request.DeleteGroupMemberRequest;
import cn.cjsj.im.server.request.DismissGroupRequest;
import cn.cjsj.im.server.request.FriendInvitationRequest;
import cn.cjsj.im.server.request.JoinGroupRequest;
import cn.cjsj.im.server.request.LoginRequest;
import cn.cjsj.im.server.request.QuitGroupRequest;
import cn.cjsj.im.server.request.RegisterRequest;
import cn.cjsj.im.server.request.RemoveFromBlacklistRequest;
import cn.cjsj.im.server.request.RestPasswordRequest;
import cn.cjsj.im.server.request.SendCodeRequest;
import cn.cjsj.im.server.request.SetFriendDisplayNameRequest;
import cn.cjsj.im.server.request.SetGroupDisplayNameRequest;
import cn.cjsj.im.server.request.SetGroupNameRequest;
import cn.cjsj.im.server.request.SetGroupPortraitRequest;
import cn.cjsj.im.server.request.SetNameRequest;
import cn.cjsj.im.server.request.SetPortraitRequest;
import cn.cjsj.im.server.request.VerifyCodeRequest;
import cn.cjsj.im.server.response.AddGroupMemberResponse;
import cn.cjsj.im.server.response.AddToBlackListResponse;
import cn.cjsj.im.server.response.AgreeFriendsResponse;
import cn.cjsj.im.server.response.ChangePasswordResponse;
import cn.cjsj.im.server.response.CheckPhoneResponse;
import cn.cjsj.im.server.response.CreateGroupResponse;
import cn.cjsj.im.server.response.DefaultConversationResponse;
import cn.cjsj.im.server.response.DeleteFriendResponse;
import cn.cjsj.im.server.response.DeleteGroupMemberResponse;
import cn.cjsj.im.server.response.DismissGroupResponse;
import cn.cjsj.im.server.response.FriendInvitationResponse;
import cn.cjsj.im.server.response.GetBlackListResponse;
import cn.cjsj.im.server.response.GetFriendInfoByIDResponse;
import cn.cjsj.im.server.response.GetGroupInfoResponse;
import cn.cjsj.im.server.response.GetGroupMemberResponse;
import cn.cjsj.im.server.response.GetGroupResponse;
import cn.cjsj.im.server.response.GetTokenResponse;
import cn.cjsj.im.server.response.GetUserInfoByIdResponse;
import cn.cjsj.im.server.response.GetUserInfoByPhoneResponse;
import cn.cjsj.im.server.response.GetUserInfosResponse;
import cn.cjsj.im.server.response.JoinGroupResponse;
import cn.cjsj.im.server.response.LoginResponse;
import cn.cjsj.im.server.response.QiNiuTokenResponse;
import cn.cjsj.im.server.response.QuitGroupResponse;
import cn.cjsj.im.server.response.RegisterResponse;
import cn.cjsj.im.server.response.RemoveFromBlackListResponse;
import cn.cjsj.im.server.response.RestPasswordResponse;
import cn.cjsj.im.server.response.SendCodeResponse;
import cn.cjsj.im.server.response.SetFriendDisplayNameResponse;
import cn.cjsj.im.server.response.SetGroupDisplayNameResponse;
import cn.cjsj.im.server.response.SetGroupPortraitResponse;
import cn.cjsj.im.server.response.SetNameResponse;
import cn.cjsj.im.server.response.SetPortraitResponse;
import cn.cjsj.im.server.response.SyncTotalDataResponse;
import cn.cjsj.im.server.response.UserRelationshipResponse;
import cn.cjsj.im.server.response.VerifyCodeResponse;
import cn.cjsj.im.server.response.SetGroupNameResponse;
import cn.cjsj.im.server.response.VersionResponse;
import cn.cjsj.im.server.utils.NLog;
import cn.cjsj.im.server.utils.json.JsonMananger;
