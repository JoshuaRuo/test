...
/**
 * Created by LuoYang on 2018/4/18.
 * 物品申购
 */

public class ApplyBuyPropertyActivity extends BaseActivity implements View.OnClickListener{

    @Bind(R.id.property_webview)
    WebView mWebView;
    @Bind(R.id.property_progressbar)
    ...
    private static final String TAG = "ApplyBuyPropertyActivity";

    private static final String BASE_URL = ConstantValue.WEB_BASE_URL + "html/goods/goodsList.html";
    private static final String BASE_apply_URL = ConstantValue.WEB_BASE_URL + "html/goods/goodsPurchase.html";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_apply_property);
        ...
        mWebView.setWebViewClient(new WebViewClient(){
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                if (url.contains("protocol://android.finish")) {
                    ...
                    return true;
                } else if (url.contains("goods_detail.html")) {
                    mHeadRightText.setVisibility(View.VISIBLE);
            ...
            case R.id.btn_left:
                if (isContact) {
                    ...
                    if (mHisIndex != 0) {//当webview不是处于第一页面时，返回上一个页面
                        ...
                        if (mWebView.getUrl().contains("goodsList.html")) {
                            mHeadRightText.setVisibility(View.VISIBLE);
                            mHeadRightText.setText("新增");
                            mIsApplyHistory = false;
                            mIsApplyApproval = false;
                        ...
                        } else if (mWebView.getUrl().contains("goods_detail.html")) {
                            mIsApplyApproval = true;
                            mIsApplyHistory = false;
                            mHeadRightText.setText("审批进度");
                            mHeadRightText.setVisibility(View.VISIBLE);
...
//                    mWebView.reload();
    ...
    class MyChromeViewClient extends WebChromeClient {
        ...
        public void onCloseWindow(WebView window) {
            ApplyBuyPropertyActivity.this.finish();
        ...
        public boolean onJsAlert(WebView view, String url, String message,
            ...
            new AlertDialog.Builder(ApplyBuyPropertyActivity.this)
                    .setTitle("提示信息")
                    .setMessage(message)
    ...
    class Controller {
        ...
        Activity getActivity() {
            return ApplyBuyPropertyActivity.this;
        }
    }
