...
import cn.cjsj.im.utils.SpecialCalendar;
...
public class CalendarAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView defaultYes = convertView.findViewById(R.id.calendar_yes_log_iv); //已经写了日志
        ImageView noLog = convertView.findViewById(R.id.calendar_no_log_iv); //没有写日志
...
//		}
        ...
        if (currentFlag == position) {
            // 设置当天的背景
//			drawable = res.getDrawable(R.drawable.calendar_item_selected_bg);
//			drawable = new ColorDrawable(ContextCompat.getColor(context,R.color.color_cccc));
